...
A matrix might at first appear similar to a data frame, but it has an additional constriant: rather than each column having a single type, *ALL* data in the matrix has the same type.
