...
We have already downloaded this SRAdb file for you to the `shared-data` folder.
...
# This directory was already created for you
...
The file you need is already downloaded for you in `shared-data/SRAdb` but we 
are including this code chunk so you know how to obtain this file outside of our 
RStudio Server. 
